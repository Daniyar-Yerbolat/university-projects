...
public class Game {
	...
	private void createRooms() {
		Room outside, theater, pub, lab, office, tower, dungeon, library;
		// create the rooms
		...
		theater.setExit("up", tower);
		theater.setExit("down", dungeon);
		...
		tower.setExit("down", theater);
		
		dungeon.setExit("up", theater);
