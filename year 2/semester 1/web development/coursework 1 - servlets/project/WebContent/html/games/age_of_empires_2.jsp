...
<body>
	...
	<div class="block">
		...
		<div id="container-content-3">
			<%!Item game = new Item("game", "Age of Empires 2", 7.99f, "Microsoft", "Ensemble Studios",
			new GregorianCalendar(1999, Calendar.SEPTEMBER, 30), new String[] { "Real Time Strategy" }, "Genie engine", "../../images/posters/aoe2.jpg");
	...
	String serializedObject = "";%>
			...
			<div id="intro-div">
				...
				<img id="game" src="<%=game.getImage()%>" alt="<%=game.getTitle()%>" />
