...
<body>
	...
	<div class="block">
		...
		<div id="container-content-3">
			<%!Item game = new Item("game", "Call of Duty", 12.49f, "Activision", "Infinity Ward",
			new GregorianCalendar(2003, Calendar.OCTOBER, 29), new String[] { "Shooter" }, "id Tech 3 Engine",
			"../../images/posters/cod1.jpg");
	...
	String serializedObject = "";%>
			...
			<div id="intro-div">
				...
				<img id="game" src="<%=game.getImage()%>" alt="call of duty" />
