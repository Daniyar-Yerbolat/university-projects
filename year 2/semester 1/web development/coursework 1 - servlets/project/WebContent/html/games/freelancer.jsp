...
<body>
	...
	<div class="block">
		...
		<div id="container-content-3">
			<%!Item game = new Item("game", "Deus Ex Human Revolution", 40.0f, "Square Enix", "Eidos Montreal",
			new GregorianCalendar(2011, Calendar.AUGUST, 23), new String[] { "Shooter", "Role Player Game", "Stealth" },
			"in-house engine", "../../images/");
