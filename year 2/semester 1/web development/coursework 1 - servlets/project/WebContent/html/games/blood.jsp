...
<body>
	...
	<div class="block">
		...
		<div id="container-content-3">
			<%!Item game = new Item("game", "Blood", 0.49f, "GT Interactive Software", "	Monolith Productions",
			new GregorianCalendar(1997, Calendar.MAY, 31), new String[] { "Shooter" }, "in-house engine",
			"../../images/posters/blood.jpg");
