...
<body>
	...
	<div class="block">
		...
		<div id="container-content-3">
			<%!Item game = new Item("game", "Mass Effect 2", 29.99f, "Electronic Arts", "BioWare",
			new GregorianCalendar(2010, Calendar.JANUARY, 26), new String[] { "Shooter", "Role Playing Game" },
			"Unreal Engine 3", "../../images/");
	...
	String serializedObject = "";%>
			...
			<div id="intro-div">
				...
				<img id="game" src="<%=game.getImage()%>" alt="mass effect 2" />
