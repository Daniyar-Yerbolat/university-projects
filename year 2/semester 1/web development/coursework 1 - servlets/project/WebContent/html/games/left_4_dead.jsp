...
<body>
	...
	<div class="block">
		...
		<div id="container-content-3">
			<%!Item game = new Item("game", "Left 4 Dead", 40.0f, "Valve", "Turtle Rock Studios",
			new GregorianCalendar(2008, Calendar.NOVEMBER, 17), new String[] { "Coop", "Shooter" }, "Source Engine",
			"../../images/posters/left_4_dead.jpg");
	...
	String serializedObject = "";%>
			...
			<div id="intro-div">
				...
				<img id="game" src="<%=game.getImage()%>" alt="left 4 dead" />
