...
<body>
	...
	<div class="block">
		...
		<div id="container-content-3">
			<%!Item game = new Item("game", "Civilization V", 29.99f, "2K", "Firaxis Games",
			new GregorianCalendar(2010, Calendar.SEPTEMBER, 21), new String[] { "4X" }, "in-house engine",
			"../../images/posters/civ5.jpg");
	...
	String serializedObject = "";%>
			...
			<div id="intro-div">
				...
				<img id="game" src="<%=game.getImage()%>" alt="Civilization V" />
