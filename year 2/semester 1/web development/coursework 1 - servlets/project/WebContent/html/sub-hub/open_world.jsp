...
<div class="block">
	<div id="intro">
		<hr/>
	<h1>MOBAs</h1>
	<p>Massive Online Battle Arena, otherwise known as Action-RTS.</p>
	<p>A genre that requires a lot of skill and teamwork.</p>
	<hr/>
	</div>		
	...
	<div id="container-content-2">
			<ul>
				<li><a href="../games/dota_2.jsp"><img src="../../images/dota-2.png" alt="Dota 2"/></a></li>
			</ul>
	</div>
<br class="clear"/>
</div>
<footer>
		...
		<ul>
			...
			<li>Contact through <a href="https://steamcommunity.com/id/daniel_faraday"><img src="../../images/steam.png" alt="steam icon"/></a></li>
			<li>or by <a href="mailto:">email</a>.</li>
		</ul>
