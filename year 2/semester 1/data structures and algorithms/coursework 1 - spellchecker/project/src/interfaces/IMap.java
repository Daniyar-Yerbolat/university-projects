...
public interface IMap {
	...
	/**
	 * Inserts an entry to the map. Throws exception if key is already present
	 */
	...
	/**
	 * Returns true if there is entry with specified key in the map
	 */
	...
	/**
	 * Returns iterator object over all elements stored in the map
	 */
