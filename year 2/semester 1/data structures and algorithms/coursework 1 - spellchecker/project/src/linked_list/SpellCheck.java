...
public class SpellCheck {
	private LinkedListMap linkedlistmap;
	...
	public SpellCheck(String dictionary, String file) throws MapException, IOException {
	...
	private void checkFile(String file) throws MapException {
	...
	private void addDictionary(String dictionary) throws MapException {
		System.out.println("adding dictionary to linked list map: ");
	...
	private String correctWord(String word) throws MapException {
		...
		if (linkedlistmap.find(word)) {
			...
			return_string = return_string + (remove_duplicates(correction_substitution(word), correction_omission(word),
					correction_insertion(word), correction_reversal(word))).toString();
		}
	...
	private String remove_duplicates(String[] substitution, String[] omission, String[] insertion, String[] reversal)
			throws MapException {
		String string = "";
		LinkedListMap corrected_words = new LinkedListMap();
	...
	private String[] correction_substitution(String word) {
		...
		for (int x = 0; x < char_array.length; x++) {
			...
			while (alphabet <= 'z') {
				...
				if (linkedlistmap.find(s) && i < correct_words.length) {
